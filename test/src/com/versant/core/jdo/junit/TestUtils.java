...
/**
 * Static utility methods used by older tests.
 */
...
//                        ((JDOConnectionImp)rPm.realJdoConnection).queryCacheSize());
//            }
        } else {
    ...
    public static VersantPersistenceManagerImp getJDOPMImp(
    ...
    public static void checkQCacheSize(int size,
            VersantPersistenceManagerImp pm) {
//        if (pm.realJdoConnection instanceof JDOConnectionImp) {
//            Assert.assertEquals(size,
//                    ((JDOConnectionImp)pm.realJdoConnection).queryCacheSize());
//        }
    }

    public static boolean isHollow(Object pc) {
        return (((PMProxy)JDOHelper.getPersistenceManager(pc)).getRealPM()).isHollow(
                pc);
    }

    public static boolean isPNonTx(Object pc) {
        return (((PMProxy)JDOHelper.getPersistenceManager(pc)).getRealPM()).isPNonTx(
                pc);
    }

    public static boolean isPersistentClean(Object pc) {
        return (((PMProxy)JDOHelper.getPersistenceManager(pc)).getRealPM()).isPClean(
                pc);
    }

    public static boolean isPDirty(Object pc) {
        return (((PMProxy)JDOHelper.getPersistenceManager(pc)).getRealPM()).isPDirty(
                pc);
    }
    ...
    public static boolean isPNewDeleted(Object pc) {
        return (((PMProxy)JDOHelper.getPersistenceManager(pc)).getRealPM()).isPNewDeleted(
                pc);
    }

    public static boolean isPDeleted(Object pc) {
        return (((PMProxy)JDOHelper.getPersistenceManager(pc)).getRealPM()).isPDeleted(
                pc);
    }

    public static boolean isTClean(Object pc) {
        return (((PMProxy)JDOHelper.getPersistenceManager(pc)).getRealPM()).isTClean(
                pc);
    }

    public static boolean isTDirty(Object pc) {
        return (((PMProxy)JDOHelper.getPersistenceManager(pc)).getRealPM()).isTDirty(
                pc);
    }
    ...
    public static void dump(Object pc) {
        (((PMProxy)JDOHelper.getPersistenceManager(pc)).getRealPM()).dump(
                (OID)JDOHelper.getObjectId(pc));
    }
