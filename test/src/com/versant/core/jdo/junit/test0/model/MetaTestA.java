...
public class MetaTestA {
    ...
    public static String[] managedFieldNames = {"f0", "f1", "f4", "f5", "f8"};
    public static int[] managedFieldNos = {0, 1, 2, 3, 4};

    public static String[] txFieldsNames = {"f1", "f4"};
    public static int[] txFieldsNos = {1, 4};
}
