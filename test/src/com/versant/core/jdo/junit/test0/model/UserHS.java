 ...
 * @keep-all
 */
public class UserHS implements Comparable {

    private String name;
    private HashSet groups = new HashSet();

    public UserHS(String name) {
        this.name = name;
    }
    ...
    public void add(GroupHS g) {
        groups.add(g);
    }

    public void remove(GroupHS g) {
        groups.remove(g);
    }
    ...
    public int compareTo(Object o) {
        return name.compareTo(((UserHS)o).name);
    }
