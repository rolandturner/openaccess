 ...
 */
public class SingleIdentityCharObject extends TestObject {
     ...
     * Constructor
     */
    public SingleIdentityCharObject() {
        super();
    }
    ...
    public boolean compareTo(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof SingleIdentityCharObject))
            return false;

        SingleIdentityCharObject other = (SingleIdentityCharObject) obj;
