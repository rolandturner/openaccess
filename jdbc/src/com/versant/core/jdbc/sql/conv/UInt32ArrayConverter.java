 ...
 * @keep-all
 */
public class UInt32ArrayConverter extends TypeAsBytesConverterBase {
    ...
    public static class Factory extends TypeAsBytesConverterBase.Factory {
        ...
        protected JdbcConverter createConverter(JdbcConverter nested) {
            return new UInt32ArrayConverter(nested);
        }

    }

    public UInt32ArrayConverter(JdbcConverter nested) {
        super(nested);
    }
