...
/**
 * This converter converts int[] to and from SQL. It converts the int[]
 * to and from a byte[] and delegates to a nested converter.
 * TODO This could be done much faster with java.nio buffers.
 * @keep-all
 */
public class IntArrayConverter extends TypeAsBytesConverterBase {
    ...
    public static class Factory extends TypeAsBytesConverterBase.Factory {
        ...
        protected JdbcConverter createConverter(JdbcConverter nested) {
            return new IntArrayConverter(nested);
        }

    }

    public IntArrayConverter(JdbcConverter nested) {
        super(nested);
    }
    ...
    public Class getValueType() {
        return /*CHFC*/int[].class/*RIGHTPAR*/;
    }
