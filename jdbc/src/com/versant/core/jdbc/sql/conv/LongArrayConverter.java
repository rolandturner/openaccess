 ...
 * @keep-all
 */
public class LongArrayConverter extends TypeAsBytesConverterBase {
    ...
    public static class Factory extends TypeAsBytesConverterBase.Factory {
        ...
        protected JdbcConverter createConverter(JdbcConverter nested) {
            return new LongArrayConverter(nested);
        }

    }

    public LongArrayConverter(JdbcConverter nested) {
        super(nested);
    }
    ...
    public Class getValueType() {
        return /*CHFC*/long[].class/*RIGHTPAR*/;
    }
