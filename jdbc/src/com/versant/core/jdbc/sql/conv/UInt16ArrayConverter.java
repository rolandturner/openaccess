...
/**
 * This converter converts System.UInt16[] to and from SQL. It converts the System.UInt16[]
 * to and from a byte[] and delegates to a nested converter.
 * TODO This could be done much faster with java.nio buffers.
 * @keep-all
 */
public class UInt16ArrayConverter extends TypeAsBytesConverterBase {
    ...
    public static class Factory extends TypeAsBytesConverterBase.Factory {
        ...
        protected JdbcConverter createConverter(JdbcConverter nested) {
            return new UInt16ArrayConverter(nested);
        }

    }

    public UInt16ArrayConverter(JdbcConverter nested) {
        super(nested);
    }
