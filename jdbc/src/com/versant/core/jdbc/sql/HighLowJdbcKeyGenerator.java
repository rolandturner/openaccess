 ...
 */
public class HighLowJdbcKeyGenerator implements JdbcKeyGenerator {
    ...
    public static class Factory implements JdbcKeyGeneratorFactory{
        ...
        public JdbcKeyGenerator createJdbcKeyGenerator(String className,
            ...
            HighLowJdbcKeyGenerator kg = new HighLowJdbcKeyGenerator(
                    classTable, (Args)args);
            return kg;
        }
    }
     ...
     * will still only be called once per instance.
     */
    public void addKeyGenTables(HashSet set, JdbcMetaDataBuilder mdb) {
        ...
        JdbcColumn keyCol = new JdbcColumn(mr.resolveMapping(/*CHFC*/String.class/*RIGHTPAR*/), mr);
        keyCol.name = keyColumnName;
        keyCol.length = keyColumnLength;
        keyCol.nulls = false;
        JdbcColumn valueCol =
                new JdbcColumn(mr.resolveMapping(/*CHFC*/Integer.TYPE/*RIGHTPAR*/), mr);
