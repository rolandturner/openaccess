...
public class DetachSCOHashtableFactory implements VersantSCOMapFactory,
        Serializable {
    ...
    public VersantSimpleSCO createSCOHashMap(PersistenceCapable owner,
        ...
        return new DetachSCOHashtable(owner, stateManager, fmd, mapData);
    }

    public VersantSimpleSCO createSCOHashMap(PersistenceCapable owner,
                                              VersantPMInternal pm, VersantStateManager stateManager,
                                              VersantFieldMetaData fmd, Map map) {
        return new DetachSCOHashtable(owner, stateManager, fmd, map);
    }
