...
public class DetachSCOVectorFactory implements VersantSCOCollectionFactory,
        Serializable {

    /**
     * Create a new Detached SCOVector .
     * <p/>
    ...
    public VersantSimpleSCO createSCOCollection(PersistenceCapable owner,
        ...
        return new DetachSCOVector(owner, stateManager, fmd, Utils.getObjectsById(collectionData.values,
                collectionData.valueCount, pm, (FieldMetaData) fmd,
                fmd.isElementTypePC()));
    }

    /**
     * Create a new SCOVector instance and fill it with the data in collection.
     */
    public VersantSimpleSCO createSCOCollection(PersistenceCapable owner,
                                                 VersantPMInternal pm, VersantStateManager stateManager,
                                                 VersantFieldMetaData fmd, Collection collection) {
        return new DetachSCOVector(owner, stateManager, fmd, collection.toArray());
    }
