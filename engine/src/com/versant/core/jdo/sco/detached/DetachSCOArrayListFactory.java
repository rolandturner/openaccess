...
public class DetachSCOArrayListFactory implements VersantSCOCollectionFactory,
        Serializable {

    /**
     * Create a new DetachSCOArrayList instance.
     * <p/>
    ...
    public VersantSimpleSCO createSCOCollection(PersistenceCapable owner,
        ...
        return new DetachSCOArrayList(owner, stateManager, fmd, Utils.getObjectsById(collectionData.values,
                collectionData.valueCount, pm, (FieldMetaData) fmd,
                fmd.isElementTypePC()));
    }

    /**
     * Create a new DetachSCOArrayList instance and fill it with the data in collection.
     */
    public VersantSimpleSCO createSCOCollection(PersistenceCapable owner,
                                                 VersantPMInternal pm, VersantStateManager stateManager,
                                                 VersantFieldMetaData fmd, Collection collection) {
        return new DetachSCOArrayList(owner, stateManager, fmd, collection.toArray());
    }
