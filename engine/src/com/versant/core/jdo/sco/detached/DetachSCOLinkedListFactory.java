...
public class DetachSCOLinkedListFactory implements VersantSCOCollectionFactory,
        Serializable {

    /**
     * Create a new DetachSCOLinkedList instance .
     * <p/>
    ...
    public VersantSimpleSCO createSCOCollection(PersistenceCapable owner,
        ...
        return new DetachSCOLinkedList(owner, stateManager, fmd, Utils.getObjectsById(collectionData.values,
                collectionData.valueCount, pm, (FieldMetaData) fmd,
                fmd.isElementTypePC()));
    }

    /**
     * Create a new DetachSCOLinkedList instance and fill it with the data in collection.
     */
    public VersantSimpleSCO createSCOCollection(PersistenceCapable owner,
                                                 VersantPMInternal pm, VersantStateManager stateManager,
                                                 VersantFieldMetaData fmd, Collection collection) {
        return new DetachSCOLinkedList(owner, stateManager, fmd,
                collection.toArray());
    }
