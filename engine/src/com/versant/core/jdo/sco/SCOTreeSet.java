 ...
 * TreeSet SCO.
 */
public class SCOTreeSet extends TreeSet implements VersantManagedSCOCollection, VersantAdvancedSCO {
    ...
    public SCOTreeSet(PersistenceCapable owner, VersantStateManager stateManager,
