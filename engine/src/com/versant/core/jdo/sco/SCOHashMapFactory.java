 ...
 *
 */
public class SCOHashMapFactory implements VersantSCOMapFactory,
        Serializable {
    ...
    public VersantSimpleSCO createSCOHashMap(PersistenceCapable owner,
        ...
        return new SCOHashMap(owner, stateManager, fmd, mapData);
    }

    public VersantSimpleSCO createSCOHashMap(PersistenceCapable owner,
                                              VersantPMInternal pm, VersantStateManager stateManager,
                                              VersantFieldMetaData fmd, Map map) {
        return new SCOHashMap(owner, stateManager, fmd, map);
    }
