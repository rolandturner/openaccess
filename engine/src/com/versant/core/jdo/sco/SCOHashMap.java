...
public class SCOHashMap extends java.util.HashMap implements VersantSCOMap, VersantAdvancedSCO {
    ...
    private SCOHashMap(PersistenceCapable owner,
    ...
    public SCOHashMap(PersistenceCapable owner, VersantStateManager stateManager,
    ...
    public Set keySet() {
        ...
        final class TmpKeySet extends AbstractSet {
            ...
            public boolean remove(Object o) {
                Object removed = SCOHashMap.this.remove(o);
                return removed != null;
            }
        }
