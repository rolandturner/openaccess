 ...
 *
 */
public class SCOHashSetFactory implements VersantSCOCollectionFactory,
        Serializable {

    /**
     * Create a new SCOHashSet instance that implements the
    ...
    public VersantSimpleSCO createSCOCollection(PersistenceCapable owner,
        ...
        Object[] originalData = Utils.getObjectsById(collectionData.values,
                ...
                fmd.isElementTypePC());
        return new SCOHashSet(owner, stateManager, fmd, originalData);
    }

    /**
     * Create a new SCOHashSet instance that implements the VersantSCOCollection
     * interface and fill it with the data in collection.
     */
    public VersantSimpleSCO createSCOCollection(PersistenceCapable owner,
                                                 VersantPMInternal pm, VersantStateManager stateManager,
                                                 VersantFieldMetaData fmd, Collection collection) {
        return new SCOHashSet(owner, stateManager, fmd, collection.toArray());
    }
