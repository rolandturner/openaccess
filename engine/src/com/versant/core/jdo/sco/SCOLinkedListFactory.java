 ...
 *
 */
public class SCOLinkedListFactory implements VersantSCOCollectionFactory,
        Serializable {

    /**
     * Create a new SCOLinkedList instance that implements the
    ...
    public VersantSimpleSCO createSCOCollection(PersistenceCapable owner,
        ...
        Object[] originalData = Utils.getObjectsById(collectionData.values,
                ...
                fmd.isElementTypePC());
        return new SCOLinkedList(owner, stateManager, fmd, originalData);
    }

    /**
     * Create a new SCOLinkedList instance that implements the VersantSCOCollection
     * interface and fill it with the data in collection.
     */
    public VersantSimpleSCO createSCOCollection(PersistenceCapable owner,
                                                 VersantPMInternal pm, VersantStateManager stateManager,
                                                 VersantFieldMetaData fmd, Collection collection) {
        return new SCOLinkedList(owner, stateManager, fmd,
                collection.toArray());
    }
