...
public final class QueryStateWrapper extends State {
    ...
    public Object getInternalObjectField(int field) {
        return pcStateMan.getObjectField(null,
                cmd.stateFields[field].managedFieldNo, null);
    }
    ...
    public QueryStateWrapper getState(int field) {
        QueryStateWrapper state = pm.getInternalSM(
                (PersistenceCapable)getInternalObjectField(field)).queryStateWrapper;
        return state;
    }

    public boolean getBooleanField(int field) {
        return pcStateMan.getBooleanField(null,
                cmd.stateFields[field].managedFieldNo, false);
    }

    public char getCharField(int field) {
        return pcStateMan.getCharField(null,
                cmd.stateFields[field].managedFieldNo, (char)0);
    }

    public byte getByteField(int field) {
        return pcStateMan.getByteField(null,
                cmd.stateFields[field].managedFieldNo, (byte)0);
    }

    public short getShortField(int field) {
        return pcStateMan.getShortField(null,
                cmd.stateFields[field].managedFieldNo, (short)0);
    }

    public int getIntField(int field) {
        return pcStateMan.getIntField(null,
                cmd.stateFields[field].managedFieldNo, 0);
    }

    public long getLongField(int field) {
        return pcStateMan.getLongField(null,
                cmd.stateFields[field].managedFieldNo, 0);
    }
    ...
    public float getFloatField(int field) {
        return pcStateMan.getFloatField(null,
                cmd.stateFields[field].managedFieldNo, 0);
    }

    public double getDoubleField(int field) {
        return pcStateMan.getDoubleField(null,
                cmd.stateFields[field].managedFieldNo, 0);
    }

    public String getStringField(int field) {
        return pcStateMan.getStringField(null,
                cmd.stateFields[field].managedFieldNo, null);
    }
    ...
    public Object getObjectField(int field, PersistenceCapable owningPC,
            VersantPMProxy sm, OID oid) {
        throw createBadMethodException();
    }

    public Object getObjectFieldAbs(int field, PersistenceCapable owningPC,
            VersantPMProxy sm, OID oid) {
        throw createBadMethodException();
    }
