 ...
 * A equality test.
 */
public class LikeNode extends EqualNode {

    public LikeNode(Node left, Node right) {
        super(left, right);
    }

    public Object accept(NodeVisitor visitor, Object[] results) {
      return visitor.visitLikeNode(this, results);
    }

    public Field visit(MemVisitor visitor, Object obj) {
        return visitor.visitLikeNode(this, obj);
    }
