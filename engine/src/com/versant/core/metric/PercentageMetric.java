...
/**
 * A performance metric that is a / b expressed as a percentage.
 * @keep-all
 */
public class PercentageMetric extends DerivedMetric {

    private final Metric a;
    private final Metric b;

    public PercentageMetric(String name, String displayName, String category,
