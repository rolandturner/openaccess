...
public class BindingSupportImpl 
{
	...
	public RuntimeException duplicateKey(String msg, Throwable nested, 
										 Object failed)
	{
		return new VersantDuplicateKeyException(msg, findCause(nested));
	}

	public RuntimeException lockNotGranted(String msg, Throwable[] nested, 
									Object failed)
	{
		if (nested==null)
			return new VersantLockTimeoutException(msg);
	...
	{
		return new JDOUserException(msg, findCause(cause));		//no specific exception class yet for JDO Genie
	}
	...
	{
		return new JDOUserException(msg, (Throwable)null);		//no specific exception class yet for JDO Genie
	}	
	
	public boolean isOwnQueryException(Throwable e)
	{
		return e instanceof JDOUserException;			//no specific exception class yet for JDO Genie
	}
