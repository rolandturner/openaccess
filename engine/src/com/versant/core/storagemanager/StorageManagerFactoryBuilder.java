...
/**
 * Bean to create StorageManagerFactory's. 
 */
public class StorageManagerFactoryBuilder {
    ...
    private boolean ignoreConFactoryProperties;
    ...
    private StorageManagerFactory createSmfForURL() {
        ...
        try {
            ...
            Constructor cons = cls.getConstructor(
                new Class[]{/*CHFC*/StorageManagerFactoryBuilder.class/*RIGHTPAR*/});
    ...
    public void setIgnoreConFactoryProperties(boolean b) {
        this.ignoreConFactoryProperties = b;
    }

    /**
     * If set the this will ignore any jndi based lookups for DataSources and a
     * the normal properties will be used to create a connection pool
     * @return
     */
    public boolean isIgnoreConFactoryProperties() {
        return ignoreConFactoryProperties;
    }
}
