 ...
 *
 * @see com.versant.core.jdo.QueryResult
 */
public final class ForwardEJBQueryResult extends QueryResultBase
    ...
    public ForwardEJBQueryResult(EMProxy pmProxy, QueryDetails queryDetails,
     ...
     */
    public boolean isCompiledQueryEqual(ForwardEJBQueryResult qc) {
     ...
     *
     * @see com.versant.core.jdo.QueryResultIterator
     */
    ...
    private ListIterator createInternalIterImp(boolean doNotFlush) {
        checkClosed();
        EJBQueryIterator queryIterator = new EJBQueryIterator(pm, compiledQuery, params, doNotFlush);
