...
/**
 * @keep-all
 * A JPopupMenu that uses a DecoratedGrid and ExpTableModel to
 * display a list of data in a popup.
 *
 */
...
//    static Config cfg = Config.getInstance(InsightPopup.class);
    ...
    public InsightBody getBody() {
        return body;
    }

    public void setBody(InsightBody body) {
     ...
     */
    public void setSelectedIndex(int index) { body.setSelectedIndex(index); }

    /**
     * Get the index of the selected object in our data list.
     */
    public int getSelectedIndex() { return body.getSelectedIndex(); }

    /**
     * Move the selected value in the list up by one.
     */
    public void moveUp() { body.moveUp(); }

    /**
     * Move the selected value in the list down by one.
     */
    public void moveDown() { body.moveDown(); }

    /**
     * Move the selected value in the list up by one page.
     */
    public void movePageUp() { body.movePageUp(); }

    /**
     * Move the selected value in the list down by one page.
     */
    public void movePageDown() { body.movePageDown(); }

    /**
     * Get the size of our data list.
     */
    public int getListSize() { return body.getListSize(); }

    /**
     * Get the selected value in the list.
     */
    public Object getSelectedValue() { return body.getSelectedValue(); }

    /**
     * Jumps to the entry in the list that most resembles String word and
     * highlights it.
     */
    public void setInsightWord(String word) { body.setInsightWord(word); }
