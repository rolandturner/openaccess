 ...
 * @keep-all
 */
public class OrderingPopupInputHandler extends KeyAdapter {
    ...
    private OrderingPopupInputHandler(OrderingPopupInputHandler copy) {
        bindings = currentBindings = copy.bindings;
    }

    public OrderingPopupInputHandler() {
...
//        addKeyBinding("RIGHT", POPUP_NEXT_CHAR);
     ...
     */
    public OrderingPopupInputHandler copy() {
        return new OrderingPopupInputHandler(this);
    }
...
//                        System.out.println("in o == null && currentBindings != bindings");
            ...
            evt.consume();
            FocusManager.getCurrentManager().focusNextComponent(orderingPane);
        }
    }
    ...
    public void keyTyped(KeyEvent evt) {
        ...
        if (c != KeyEvent.CHAR_UNDEFINED && (modifiers & KeyEvent.ALT_MASK) == 0 && (modifiers & KeyEvent.CTRL_MASK) == 0) {
            if (c >= 0x20 && c != 0x7f) {
    ...
    public void setPane(OrderingPane orderingPane) {
        this.orderingPane = orderingPane;
