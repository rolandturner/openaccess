 ...
 */ 
public class SQLFormatterToken extends Token {
    /**
     ...
     * A reserved word (keyword)
     */
    public final static int RESERVED_MAYBE = 0x600;
    /**
     * A reserved word (keyword)
     */
    public final static int RESERVED_NEWLINE = 0xA00;
    /**
     * A reserved word (keyword)
     */
    public final static int ENDLINE = 0xB00;

    public final static int STARTMARK = 0xC00;
    public final static int ENDMARK = 0xC10;
    /**
     ...
     */
    public SQLFormatterToken(int ID, String contents, int lineNumber, int charBegin, int charEnd){
     ...
     */
    public SQLFormatterToken(int ID, String contents, int lineNumber, int charBegin, int charEnd, int state){
        this.ID = ID;
