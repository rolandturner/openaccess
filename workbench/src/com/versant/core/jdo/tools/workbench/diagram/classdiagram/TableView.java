...
/**
 * View for a TableCell.
 * @keep-all
 */
public class TableView extends VertexView implements CellViewRenderer, CellHandle {
    ...
    public TableView(Object o, JGraph jGraph, CellMapper cellMapper) {
