 ...
 */
public class VDSFieldPropertyForm extends WorkbenchPanel {
    ...
    private VDSSpecialFieldPropertyForm formSpecial = new VDSSpecialFieldPropertyForm();
    private VDSSimpleFieldPropertyForm formSimple = new VDSSimpleFieldPropertyForm();
    private VDSExternalizedFieldPropertyForm formExternalized = new VDSExternalizedFieldPropertyForm();
    private VDSRefFieldPropertyForm formRef = new VDSRefFieldPropertyForm();
    private VDSCollectionFieldPropertyForm formCollection = new VDSCollectionFieldPropertyForm();
//    private VDSObjectFieldPropertyForm formObject = new VDSObjectFieldPropertyForm();
    private VDSRefFieldPropertyForm formObject = new VDSRefFieldPropertyForm();
    private VDSMapFieldPropertyForm formMap = new VDSMapFieldPropertyForm();

    private XmlPreviewPanel xmlPreview = new XmlPreviewPanel("xmlPreview",
            true);

    public VDSFieldPropertyForm() throws Exception {
    ...
    private FieldPropertyForm.SubForm getSubFormForField(MdField f) {
        ...
        // when persistent to choose a dialog. Currently this is only done
        // for POLYREF/COLLECTIONS/MAP as the new dialogs are not ready yet.
