 ...
 * @keep-all
 */
public class JdoqlToken extends Token {

    public final static int RESERVED_WORD_THIS = 0x128;

    public final static int RESERVED_WORD_NULL = 0x129;

    public final static int RESERVED_WORD_BOOLEAN = 0x12A;
    ...
    public final static int IDENTIFIER_CAST = 0x203;
    ...
    public final static int SPECIAL_ID_SQL = 35;
    ...
    public final static int TYPE_CAST = 17;
     ...
     */
    public JdoqlToken(int ID, String contents, int lineNumber, int charBegin, int charEnd){
     ...
     */
    public JdoqlToken(int ID, String contents, int lineNumber, int charBegin, int charEnd, int state){
        this.ID = ID;
    ...
    public JdoqlToken getPrevToken(){
        return prevToken;
    }

    public void setPrevToken(JdoqlToken prevToken) {
